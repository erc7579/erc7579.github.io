...
<Cards >
  <Card
    ...
    icon={<Image src="/biconomy.jpeg" width={50} height={50} alt="" style={{borderRadius:"5px", marginRight:"5px"}}/>}
    />
  <Card 
  title="ZeroDev"
  href="https://zerodev.app/"
  icon={<Image src="/zerodev.png" width={50} height={50} alt="" style={{borderRadius:"5px", marginRight:"5px"}}/>}
  />
  <Card
  title="Rhinestone"
    href="https://www.rhinestone.wtf/"
    icon={<Image src="/rhinestone.png" width={50} height={50} alt="" style={{borderRadius:"5px", marginRight:"5px"}}/>}
  />
  <Card
  title="OKX"
    href="https://www.okx.com/"
    icon={<Image src="/okx.jpeg" width={50} height={50} alt="" style={{borderRadius:"5px", marginRight:"5px"}}/>}
    />
