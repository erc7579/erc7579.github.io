...
The [Kernel](https://github.com/zerodevapp/kernel) is one of the most widely used smart accounts. In this tutorial, you will learn how to use the Module SDK with the Kernel.
