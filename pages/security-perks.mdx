...
A notable customer of the company that leverages the ERC-7579 architecture is [Etherspot](https://github.com/shieldify-security/audits-portfolio/blob/main/reports/Etherspot-SKVM-Security-Review.pdf).
Learn more about us at [shieldify.org](https://www.shieldify.org/).

⭐ **Benefits**

50% off the monthly subscription fee of Shieldify's subscription-based auditing approach.

📧 **Contact**

Telegram: [@researchershieldify](https://telegram.me/researcherShieldify) or email at security@shieldify.org
